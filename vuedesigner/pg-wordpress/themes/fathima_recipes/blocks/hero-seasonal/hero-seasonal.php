        ...
        <div class="py-20 sm:py-24 lg:py-32">
            <div class="max-w-3xl">
                <div class="backdrop-blur bg-white/80 p-6 ring-1 ring-white/50 rounded-xl shadow-lg sm:p-8 lg:p-10">
                    <div class="flex gap-2 items-center justify-end text-gray-700 text-sm w-full sm:text-base"> <span class="inline-flex h-2.5 w-2.5 rounded-full bg-green-500"></span> <span><?php echo PG_Blocks_v4::getAttribute( $args, 'badge_text' ) ?></span> 
                    </div>
                    <h1 class="font-semibold lg:text-5xl mt-3 sm:text-4xl text-3xl text-gray-900 text-right tracking-tight"><?php echo PG_Blocks_v4::getAttribute( $args, 'main_heading' ) ?></h1>
