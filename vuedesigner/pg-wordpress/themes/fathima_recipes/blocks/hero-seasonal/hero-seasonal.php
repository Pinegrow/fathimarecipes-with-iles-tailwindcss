        ...
        <div class="py-20 sm:py-24 lg:py-32">
            <div class="max-w-3xl">
                <div class="backdrop-blur bg-white/80 p-6 ring-1 ring-white/50 rounded-xl shadow-lg sm:p-8 lg:p-10">
                    ...
                    <h1 class="mt-3 text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight text-gray-900 text-left"><?php echo PG_Blocks_v4::getAttribute( $args, 'main_heading' ) ?></h1>
