...
( function ( blocks, element, blockEditor ) {
    ...
    const block = registerBlockType( 'fathima-recipes/hero-seasonal', {
        ...
        attributes: {
            ...
            badge_text: {
                type: ['string', 'null'],
                default: `Home gardening made simple`,
            },
            main_heading: {
                type: ['string', 'null'],
